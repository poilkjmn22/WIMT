...
function calculateViewport() {
    ...
    document.getElementById('main-content').setAttribute('style', `width: ${viewport[0] + 2 * layoutSize.mainPadding + (document.getElementById('state-modules').offsetWidth + layoutSize.chartRoomMargin)}px;height: ${viewport[1] + 2 * layoutSize.mainPadding}px;visibility: visible;`)
